...
For more information on checking and using Appkeys, please refer to the [Appkey](/en/nhncloud/en/public-api/appkey).
...
User Access Keys and Secret Access Keys can be issued in the console's API Security Setting. For more information on issuing and using User Access Key, please refer to the [User Access Key](/en/nhncloud/en/public-api/user-access-key).
